...
public class InternController {
    ...
    @Operation(summary = "Update an intern's track")
    @PreAuthorize("hasRole('SUPER_ADMIN')")
    @PostMapping("{userId}/track")
    @ResponseStatus(HttpStatus.OK)
    public InternDto updateInternTrack(
        @PathVariable UUID userId,
        @Valid @RequestBody InternDto.UpdateInternTrackDto dto
    ) {
        return internService.updateInternTrack(userId, dto);
    }
    ...
    public Page<InternDto> getInternsByTrack(
    ...
    public Page<InternDto> getInternsByStatus(
        @PathVariable InternStatus internStatus,
        Pageable pageable
    ) {
