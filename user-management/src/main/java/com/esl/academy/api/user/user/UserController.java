...
import static com.esl.academy.api.user.user.UserDto.*;
...
public class UserController {
    ...
    public UserDto changeUserRole(@PathVariable UUID userId,
    ...
    public UserDto changeUserStatus(@PathVariable UUID userId,
    ...
    @Operation(summary = "Delete any user in the system")
    @PreAuthorize("hasRole('SUPER_ADMIN')")
    ...
    @Operation(summary = "Search supervisors by optional filters: assignedTrackId, status, createdAt, name")
    @GetMapping("supervisors/search")
    @PreAuthorize("hasRole('SUPER_ADMIN')")
    public Page<UserDto> searchSupervisors(@RequestParam(required = false) UUID assignedTrackId,
    ...
    @Operation(summary = "Search super_admins by optional filters: status, createdAt, name, email")
    @GetMapping("super_admins/search")
    @PreAuthorize("hasRole('SUPER_ADMIN')")
    public Page<UserDto> searchSuperAdmins(@RequestParam(required = false) UserStatus status,
                                           @RequestParam(required = false) OffsetDateTime createdAt,
                                           @RequestParam(required = false) String name,
